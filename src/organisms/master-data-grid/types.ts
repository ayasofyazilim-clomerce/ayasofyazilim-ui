import type { ColumnDef, ColumnFiltersState, ColumnPinningState, Row, RowSelectionState, SortingState, VisibilityState } from '@tanstack/react-table';
...
export interface JSONSchemaProperty {
    ...
    format?: 'date' | 'date-time' | 'email' | 'uri' | 'url' | 'uuid' | 'time' | 'badge';
...
export type CustomCellRenderer = (props: CustomCellRendererProps) => React.ReactNode;
...
export interface CustomRenderers {
    ...
    byFormat?: Partial<Record<NonNullable<JSONSchemaProperty['format']>, CustomCellRenderer>>;
}
